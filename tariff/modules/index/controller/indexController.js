var app = angular.module('index', ['app.config','ngCookies', 'angularFileUpload']);
...
app.controller('indexController', ['$scope', '$cookies', '$defaultConfig', '$http', '$timeout','$upload', function ($scope, $cookies, $defaultConfig, $http, $timeout,$upload) {
    var vm = this;
            ...
            if (vm.requireAgain) {
                ...
                $http({
                    ...
                    if(result.code == 0){
                        ...
                        location.href='PhTariffDetails.html';
                    }
