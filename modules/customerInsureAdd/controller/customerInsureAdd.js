(function () {
    ...
    angular.module('app.controllers')
        .controller('customerInsureAddController', ['$api', '$timeout', '$upload', '$http', '$state', '$scope', '$defaultConfig', '$layer', '$cookies', function ($api, $timeout, $upload, $http, $state, $scope, $defaultConfig, $layer, $cookies) {
            var vm = this;
            vm.user = JSON.parse(localStorage.getItem('user'));
            vm.popToPay = false;//去支付
            vm.popToRecharge = false;//去充值
            vm.payInfo = {
                ticketNo: '',
                source: '',
                productName: '',
